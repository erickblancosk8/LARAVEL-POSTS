                    ...
                    <div class="mx-auto">
                        ...
                        <div class="ml-auto">
                            ...
                            <a href="{{ route('registro') }}"
                               class="lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white {{ request()->routeIs('registro') ? 'text-sky-600 dark:text-white' : 'text-slate-400' }}">
                                Registro
                            </a>
                            ...
                            @auth
                                ...
                                @csrf
                                <a href="#"
                                class="py-2 text-sm font-medium rounded-md lg:px-3 hover:text-sky-600 dark:hover:text-white text-slate-400"
